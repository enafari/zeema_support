// Zeema Chatbot - Deployment Version
// Add this script to any website before </head> tag
// Usage: <script src="https://your-domain.com/deploy.js"></script>

(function() {
    'use strict';

    // Check if chatbot is already loaded
    if (window.ZeemaChatbot) {
        return;
    }
    ...
    window.ZeemaChatbot = ZeemaChatbot;
})(); 